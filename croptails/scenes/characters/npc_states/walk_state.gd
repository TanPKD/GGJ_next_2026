...
func set_movement_target() -> void:
	#不知道为什么每次第一个随机地点永远都是NavigationRegion2D的左上角，直接让牠们在那里开始好了
	...
	target_position = NavigationServer2D.map_get_random_point(navigation_agent_2d.get_navigation_map(), navigation_agent_2d.navigation_layers, true)
